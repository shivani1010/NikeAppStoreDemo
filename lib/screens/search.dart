                    ...
                    child: Center(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: "e,g.Nike Waffle One SE",
                                    ...
                                    children: [
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          children:  <TextSpan>[
                                            TextSpan(text: current.old_price.toString(), style: TextStyle(fontWeight: FontWeight.bold,decoration: TextDecoration.lineThrough)),
                                          ],
                                        ),
                                      ),
                                      SizedBox(width: 8),
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          style: DefaultTextStyle.of(context).style,
                                          children:  <TextSpan>[
                                            TextSpan(text: current.new_price.toString(), style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black)),
                                          ],
                                        ),
                                      ),
                                    ],
